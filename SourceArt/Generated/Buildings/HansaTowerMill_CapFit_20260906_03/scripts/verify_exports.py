...
if fmt=='glb':bpy.ops.import_scene.gltf(filepath=str(P/'exports/HansaTowerMill_CapFit.glb'))
else:bpy.ops.import_scene.fbx(filepath=str(P/'exports/HansaTowerMill_CapFit.fbx'))
...
with bpy.data.libraries.load(str(P/'exports/HansaTowerMill_CapFit.blend'),link=False) as (a,b):b.collections=['Review']
...
S.render.engine='BLENDER_EEVEE';S.eevee.use_gtao=True;S.eevee.gtao_distance=1;S.eevee.gtao_factor=1;S.eevee.taa_render_samples=64;S.eevee.use_soft_shadows=True;S.render.resolution_x=1100;S.render.resolution_y=1100;S.render.resolution_percentage=100;S.view_settings.view_transform='Filmic';S.view_settings.look='Medium High Contrast';S.render.image_settings.file_format='PNG'
for name in ['Cap_Fit']:

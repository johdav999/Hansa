...
source = root/'SourceArt/UI/Residence'
dest = root/'Content/Hansa/UI/Residence'
source.mkdir(parents=True, exist_ok=True)
dest.mkdir(parents=True, exist_ok=True)
references = {'citizen': root/'SourceArt/UI/Residence/residence--citizen--default--1254x1254--v1.png'}

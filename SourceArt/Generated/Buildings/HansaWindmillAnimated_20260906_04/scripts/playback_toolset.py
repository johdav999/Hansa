...
@unreal.uclass()
class HansaWindmillPlaybackTools(unreal.ToolsetDefinition):
 ...
 def runtime_sample() -> str:
  ...
  building=mill(world);child=building.get_component_by_class(unreal.ChildActorComponent);rotor=child.get_editor_property('child_actor');movement=rotor.get_component_by_class(unreal.RotatingMovementComponent)
  def transform(a):
...
_animation_registration=Registration([HansaWindmillPlaybackTools]);_animation_registration.register();unreal.log('HANSA_WINDMILL_ANIMATION_TOOL_READY')
